...
class JobOpportunitiesController < ApplicationController
  before_action :authenticate_headhunter_and_user, only: %i[show index]
  before_action :authenticate_headhunter!, except: %i[show index]
  before_action :set_job_opportunity, only: %i[edit update destroy show close]
